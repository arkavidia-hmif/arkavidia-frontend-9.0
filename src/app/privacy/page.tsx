...
function PrivacyPage() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            Arkavidia, Jl. Ganesa No.10, Lb. Siliwangi, Kecamatan Coblong, Kota Bandung,
            Jawa Barat 40132.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Arkavidia, accessible from{' '}
            <a
              href="https://arkavidia.com"
      ...
      <ul>
        <li>By email: it@arkavidia.com</li>
      </ul>
    </>
  )
}
